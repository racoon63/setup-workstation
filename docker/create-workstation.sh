...
docker run -d -p 127.0.0.1:80:8443 --rm --name=vscode-server -v "${HOME}/github:/vscode-server/projects" -v "${HOME}/gitlab:/vscode-server/projects" racoon/vscode-server      # starts a web based visual studio code server locally 
